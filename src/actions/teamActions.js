...
export function fetchTeam(teamID) {
  return function(dispatch) {
    ...
    return fetch(
      `https://soccer.sportmonks.com/api/v2.0/teams/${teamID}?api_token=HOLCAStI6Z0OfdoPbjdSg5b41Q17w2W5P4WuoIBdC66Z54kUEvGWPIe33UYC`
    )
      .then(response =>
...
export function fetchTeamPlayers(teamID, seasonID) {
  return function(dispatch) {
    ...
    return fetch(
      `https://soccer.sportmonks.com/api/v2.0/squad/season/${seasonID}/team/${teamID}?api_token=HOLCAStI6Z0OfdoPbjdSg5b41Q17w2W5P4WuoIBdC66Z54kUEvGWPIe33UYC&include=player`
    )
      .then(response =>
        response.json().then(data => ({
          data: data,
